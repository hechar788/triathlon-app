...
interface LoadFromLocalStorageDialogProps {
    isOpen: boolean;
    onClose: () => void;
    ...
    onLoad: () => void;
    onDeleteSavedData: (id: string) => void;
}

export default function LoadFromLocalStorageDialog({
    isOpen,
    onClose,
    savedDataSummaries,
    selectedLoadId,
    ...
    onLoad,
    onDeleteSavedData
}: LoadFromLocalStorageDialogProps) {
                ...
                <div className="overflow-y-auto flex-1 space-y-4 pr-2">
                    {savedDataSummaries.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            ...
                            {savedDataSummaries.map((summary) => {
